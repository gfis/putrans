 ...
 */
package org.teherba.putrans.web;
...
public class Messages implements Serializable {
    ...
    public static void addMessageTexts(BasePage basePage) {
        ...
        smess = String.format("%03d", imess ++);
        basePage.add(laux, smess, "<a title=\"wiki\"        href=\"http://www.teherba.org/index.php/Putrans\" target=\"_new\">");
        basePage.add("en", smess, "{parm}Wiki</a> Documentation");
        basePage.add("de", smess, "{parm}Wiki</a>-Dokumentation");
        smess = String.format("%03d", imess ++);
        basePage.add(laux, smess, "<a title=\"github\"      href=\"https://github.com/gfis/putrans\" target=\"_new\">");
